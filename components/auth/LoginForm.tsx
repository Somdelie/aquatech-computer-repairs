...
export default function LoginForm() {
  ...
  // Form submission handler using Better Auth
    ...
    <section className="flex bg-teal-50 dark:bg-transparent flex-col items-center justify-center min-h-screen w-full py-6">
      <div className="w-full max-w-lg bg-white rounded shadow">
        <div className="flex flex-col p-4 items-center w-full">
          <AppLogoIcon />
          <h1 className="mb-1 text-xl font-semibold w-full text-center">Sign In to Aquatech Computers</h1>
          <p className="text-sm w-full text-center">Welcome back! Sign in to continue</p>
          <SocialLoginButtons />
